...
describe('Component Tests', () => {
  describe('Estreno Management Component', () => {
    let comp: EstrenoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EstrenoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.estrenos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
