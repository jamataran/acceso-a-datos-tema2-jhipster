...
import com.cev.accesoadatos.tema2.jhipster.service.PeliculaQueryService;
...
/**
 * REST controller for managing {@link com.cev.accesoadatos.tema2.jhipster.domain.Pelicula}.
 */
@RestController
@RequestMapping("/api")
public class PeliculaResource {
    ...
    public ResponseEntity<List<Pelicula>> getAllPeliculas(PeliculaCriteria criteria) {
        log.debug("REST request to get Peliculas by criteria: {}", criteria);
        List<Pelicula> entityList = peliculaQueryService.findByCriteria(criteria);
    ...
    public List<Pelicula> searchPeliculas(@RequestParam String query) {
        log.debug("REST request to search Peliculas for query {}", query);
