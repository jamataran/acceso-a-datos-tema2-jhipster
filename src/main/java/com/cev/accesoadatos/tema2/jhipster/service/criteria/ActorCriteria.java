...
/**
 * Criteria class for the {@link com.cev.accesoadatos.tema2.jhipster.domain.Actor} entity. This class is used
 * in {@link com.cev.accesoadatos.tema2.jhipster.web.rest.ActorResource} to receive all the possible filtering options from
...
public class ActorCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nombre, apellidos, peliculaId, distinct);
    }
