...
class ActorResourceIT {
     ...
     *
     * @see com.cev.ad.tema2.repository.search.ActorSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Actor createEntity(EntityManager em) {
        Actor actor = new Actor().nombre(DEFAULT_NOMBRE).bio(DEFAULT_BIO);
        return actor;
    }
    ...
    public static Actor createUpdatedEntity(EntityManager em) {
        Actor actor = new Actor().nombre(UPDATED_NOMBRE).bio(UPDATED_BIO);
        return actor;
    }
    ...
    @Test
    @Transactional
    void getAllActorsByBioIsEqualToSomething() throws Exception {
        // Initialize the database
        actorRepository.saveAndFlush(actor);
    ...
    @Test
    @Transactional
    void getAllActorsByBioIsNotEqualToSomething() throws Exception {
        // Initialize the database
        actorRepository.saveAndFlush(actor);
    ...
    @Test
    @Transactional
    void getAllActorsByBioIsInShouldWork() throws Exception {
        // Initialize the database
        actorRepository.saveAndFlush(actor);
    ...
    @Test
    @Transactional
    void getAllActorsByBioIsNullOrNotNull() throws Exception {
        // Initialize the database
        actorRepository.saveAndFlush(actor);
    ...
    @Test
    @Transactional
    void getAllActorsByBioContainsSomething() throws Exception {
        // Initialize the database
        actorRepository.saveAndFlush(actor);
    ...
    @Test
    @Transactional
    void getAllActorsByBioNotContainsSomething() throws Exception {
        // Initialize the database
        actorRepository.saveAndFlush(actor);
    ...
    void putNewActor() throws Exception {
        ...
        updatedActor.nombre(UPDATED_NOMBRE).bio(UPDATED_BIO);
    ...
    void fullUpdateActorWithPatch() throws Exception {
        ...
        partialUpdatedActor.nombre(UPDATED_NOMBRE).bio(UPDATED_BIO);
